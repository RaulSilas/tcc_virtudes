...
import br.gov.sp.etec.DAO.PresencaDAO;
 ...
 * @author Tami
 */
public class ListaPresençaGUI extends javax.swing.JFrame {

    /**
     * Creates new form Modelo
     */
    public ListaPresençaGUI() {
        initComponents();
        jButtonApagar.setVisible(false);
    }

    int contador;
    String conta[] = new String[30];
    String nome[] = new String[30];
    boolean presenca[] = new boolean[30];
    String turma[] = new String[30];
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/gov/sp/etec/icons/Chamada_32px.png"))); // NOI18N
        jLabel5.setText("Chamada");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabelMinimizar1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jScrollPane1.setBounds(130, 200, 720, 290);
        ...
        jButtonSalvar.setBounds(760, 530, 90, 40);

        jButtonConsultar.setBackground(new java.awt.Color(102, 0, 0));
        ...
        jButtonConsultar.setText("Consultar Faltas");
        ...
        jButtonConsultar.setBounds(700, 140, 150, 40);
        ...
        jButtonApagar.setBounds(570, 530, 150, 40);
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        int result = JOptionPane.showConfirmDialog(null, "Deseja salvar as alterações?", "Virtudes", JOptionPane.YES_NO_CANCEL_OPTION);
        if (result == JOptionPane.YES_OPTION) {
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                if (nome[i] != null && presenca[i] != false) {
                    c.setNome_aluno(nome[i]);
                    c.setPresenca(presenca[i]);
                    c.setDia(formatarDate.format(data));
                    dao.insert(c);
                }
            }
...
//        System.out.print(formatarDate.format(data));
    ...
    private void jButtonApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonApagarActionPerformed
        ...
        c.setId_registro(Integer.parseInt(jTable1.getValueAt(i, 0).toString()));
    ...
    void loadSalvo() { // Método para popular a jtable com os dados do banco de dados (tabela referente a turma b
        JTableHeader header = jTable1.getTableHeader();
        DefaultTableCellRenderer center = (DefaultTableCellRenderer) header.getDefaultRenderer();
        center.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        try {
            Connection con = null;
            PreparedStatement ps = null;
            String sql = "SELECT ID_REGISTRO, NOME_ALUNO, PRESENCA, DIA FROM PRESENCA order by ID_REGISTRO";
...
//                turma[i] = (String) jTable1.getValueAt(i, 2);
                presenca[i] = (Boolean) jTable1.getValueAt(i, 2);
            }
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaPresençaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
